    ...
    return (
      <div className="bg-gray-50 min-h-screen">
        <div className="container mx-auto px-4 py-8">
          <h1 className="text-3xl  text-gray-900 font-bold mb-4">Privacy Policy</h1>
          ...
          <h2 className="text-2xl font-bold  text-gray-800 mb-2">Information We Collect</h2>
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-800">How We Use the Information</h2>
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-800">Security</h2>
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-800">Cookies</h2>
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-800">Links to Other Websites</h2>
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-800">Controlling Your Personal Information</h2>
  
          <p className="mb-4 text-gray-600">You may choose to restrict the collection or use of your personal information in the following ways:</p>
  
          <ul className="list-disc list-inside mb-4 text-gray-600">
            <li>
              If you have previously agreed to us using your personal information for direct marketing purposes, you may
              change your mind at any time by writing to or emailing us at <Link to="mailto:contact@example.com">contact@example.com</Link>
            </li>
            <li>
            ...
            <li>
              ...
              information held on you, please write to <strong>Your Company Name, Address, City, State, Zip Code</strong> or email{" "}
          ...
          <p className="mb-4 text-gray-600">This privacy policy is subject to change without notice.</p>
        </div>
      </div>
  );
};
